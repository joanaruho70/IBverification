...
!function (t) {
    ...
    *
        ...
        const vo = Symbol("observableProperties"), ko = Symbol("boundObservables"), _o = Symbol("boundProperties"),
            yo = {
                set(t, e) {
                    if (U(t)) return void Object.keys(t).forEach(e = > {this.set(e, t[e])}, this
                )
                    ;Ao(this);
                    const n = this[vo];
    ...
    )
        {
            ...
            throw new p.b("observable-bind-rebind: Cannot bind the same property more that once.")
        })
            ;const n = new Map;
    ...
    ...
    ...
    )
        {
            ...
            throw new p.b("observable-bind-to-properties-length: The number of properties must match.");
            ...
            insert(t, e) {
                (function t(e) {
                    for (const n of e) {
                        ...
                        throw new p.b("view-writer-insert-invalid-node");
            ...
            * domChildrenToView(t, e = {}) {
            ...
            focus(t) {
                ...
                if (e && e.ownerDocument.activeElement !== e) {
                    ...
                    qi(e, t = > {const{scrollLeft: e, scrollTop: n} = t;
                    o.push([e, n])
                }),
                    e.focus(), qi(e, t = > {const[e, n] = o.shift();
    ...
    ,
        ...
        class Ur extends Gi {
            constructor(t) {
                super(t), this.mutationObserver = t.getObserver(Vr), this.selection = this.document.selection, this.domConverter = t.domConverter, this._documents = new WeakSet, this._fireSelectionChangeDoneDebounced = jr(t = > this.document.fire("selectionChangeDone", t), 200
            ),
        ...
        class Ts {
            ...
            * getRanges() {
            ...
            _setRanges(t, e = !1) {
                ...
                throw new p.b("model-selection-added-not-range: Trying to add an object that is not an instance of Range.");
        ...
        class Is extends Ts {
            constructor(t) {
                ...
                if (!this._document._validateSelectionRange(t)) throw new p.b("document-selection-wrong-position: Range from document selection starts or ends at incorrect position.", {range: t})
            }),
            ...
            load(t, e = []) {
                ...
                function l(t) {
                    if (!a.includes(t) && !n.get(t) && !i.has(t)) return function (t) {
                        ...
                        throw qr.a.error("plugincollection-load: It was not possible to load the plugin.", {plugin: t}),
                        e
                    }
                )
                }
    ...
    *
        ...
        class Gs {
            ...
            getLimitElement(t) {
                ...
                if (t instanceof vs) e = t.parent; else {
                    e = (t instanceof ks ? [t] : Array.from(t.getRanges())).reduce((t, e) = > {const n = e.getCommonAncestor();
        ...
        class fa {
            constructor(t, e) {
                this.model = t, this.processor = e, this.mapper = new _s, this.downcastDispatcher = new As({mapper: this.mapper}), this.downcastDispatcher.on("insert:$text", (t, e, n) = > {if(
                !n.consumable.consume(e.item, "insert")
            )
                return;
                const o = n.writer, i = n.mapper.toViewPosition(e.range.start), r = o.createText(e.item.data);
    ...
    ,
        ...
        cu(za, Ja, (t, e, n) = > {const o = lu(t, e, n);
        ...
        cu(Ha, qa, (t, e, n) = > {if(n.undoMode || !t.position
    )
        return lu(t, e, n);
        ...
        cu(ja, Ka, (t, e, n) = > t.position && t.position.root == e.position.root && "same" === En(e.position.path, t.position.getParentPath()) ? [hu()] : lu(t, e, n)
    ),
        cu(ja, $a, (t, e, n) = > {if(
        !t.position
    )
        ...
        cu(Ka, ja, (t, e, n) = > e.position && t.position.root == e.position.root && "same" === En(t.position.path, e.position.getParentPath()) ? [e.getReversed(), t.clone()] : lu(t, e, n)
    ),
        cu(Ja, za, (t, e) = > {const n = [t.clone()];
        ...
        cu(Wa, ja, (t, e, n) = > {const o = n.undoMode, i = lu(t, e, n);
        ...
        class Ru {
            constructor(t) {
                this.model = t, this.version = 0, this.history = new Su(this), this.selection = new Rs(this), this.roots = new zo({idProperty: "rootName"}), this.differ = new xu(t.markers), this._postFixers = new Set, this.createRoot("$root", Ou), this.listenTo(t, "applyOperation", (t, e) = > {const n = e[0];
        ...
        function Uu(t, e) {
            const n = [];
            Array.from(t.getItems({direction: "backward"})).map(t = > ks.createOn(t)
        ).
        ...
        class Gu {
            constructor() {
                this.markers = new Vu, this.document = new Ru(this), this.schema = new Gs, this._pendingChanges = [], this._currentWriter = null, ["insertContent", "deleteContent", "modifySelection", "getSelectedContent", "applyOperation"].forEach(t = > this.decorate(t)
            ),
        ...
        class Qu {
            constructor(t) {
                ...
                this.config = new m(t, this.constructor.defaultConfig), this.config.define("plugins", e), this.plugins = new Hs(this, e), this.commands = new qs, this.locale = new Ws(this.config.get("language")), this.t = this.locale.t, this.set("state", "initializing"), this.once("ready", () = > this.state = "ready", {priority: "high"}
            ),
                this.once("destroy", () = > this.state = "destroyed", {priority: "high"}
            ),
                this.set("isReadOnly", !1), this.model = new Gu, this.data = new fa(this.model), this.editing = new js(this.model), this.editing.view.document.bind("isReadOnly").to(this), this.conversion = new ma, this.conversion.register("downcast", [this.editing.downcastDispatcher, this.data.downcastDispatcher]), this.conversion.register("editingDowncast", [this.editing.downcastDispatcher]), this.conversion.register("dataDowncast", [this.data.downcastDispatcher]), this.conversion.register("upcast", [this.data.upcastDispatcher]), this.keystrokes = new Yu(this), this.keystrokes.listenTo(this.editing.view.document)
            }
        ...
        class lh {
            ...
            * getViews() {
            ...
            static bind(t, e) {
                ...
                (n, o, i) =
            >
                new hh({observable: t, emitter: e, attribute: n, valueIfTrue: o, callback: i})
            }
            }
            ...
            _renderAttributes(t) {
                ...
                } else "style" == e && "string" != typeof n[0] ? this._renderStyleAttribute(n[0], t) : (s && o && Th(e) && n.unshift(o), yh(n = n.map(t = > t && t.value || t).reduce((t, e) = > t.concat(e), []).reduce(kh, "")
            )||
        ...
        function bh(t) {
            return ah(t, t = > {if(t && (t instanceof dh || Ah(t) || xh(t) || Ch(t))
        )
            return t
        })
        }
        ...
        class Oh extends Ph {
            constructor(t, e) {
                ...
                this.set("name", null);
                this.extendTemplate({attributes: {role: "textbox", "aria-label": n.to("name", t = > o("bi", [t])), class
            :
        ...
        class Mh extends Sh {
            ...
            fillFromConfig(t, e) {
                t.map(t = > {"|" == t ? this.items.add(new Vh) : e.has(t) ? this.items.add(e.create(t)) : qr.a.warn("toolbarview-item-unavailable: The requested toolbar item is unavailable.", {name: t})
            })
            }
        }
        ...
        class $h extends Gi {
            constructor(t) {
            ...
            )
                {
                    ...
                    e.fire("enter", new Mr(e, n.domEvent, {isSoft: n.shiftKey})), o && o.stop.called && t.stop()
                }
            })
            }
        ...
        class Qh extends Dh {
            ...
            init() {
                ...
                e.register("softBreak", {allowWhere: "$text"}), n.for("upcast").add(aa({
                    model: "softBreak",
                    view: "br"
                })), n.for("downcast").add(Fs({model: "softBreak", view: (t, e) = > e.createEmptyElement("br")
            })),
        ...
        class lf extends Dh {
            ...
            init() {
                ...
                t.commands.add("input", e), tf(t), function (t) {
                    t.editing.view.document.on("mutations", (e, n, o) = > {new sf(t).handle(n, o)}
                )
                }(t)
            }
        }
        ...
        class kf extends Dh {
            ...
            init() {
                const t = this.editor;
                this._undoCommand = new wf(t), this._redoCommand = new vf(t), t.commands.add("undo", this._undoCommand), t.commands.add("redo", this._redoCommand), this.listenTo(t.model, "applyOperation", (t, e) = > {const n = e[0];
        ...
        class xf extends Sh {
            ...
            _getTooltipString(t, e, n) {
                return t ? "string" == typeof t ? t : (n && (n = function (t) {
                    return Jo.isMac ? ei(t).map(t = > Qo[t.toLowerCase()] || t
                ).
                    reduce((t, e) = > t.slice(-1) in Yo ? t + e : t + "+" + e
                ):
                    t
        ...
        class Ef extends Dh {
            ...
            _addButton(t, e, n, o) {
                const i = this.editor;
                i.ui.componentFactory.add(t, r = > {const s = i.commands.get(t), a = new xf(r);
                return a.set({
                    label: e,
                    icon: o,
                    keystroke: n,
        ...
        class Ff extends Hh {
            ...
            execute(t = {}) {
                ...
                e.change(t = > {const e = Array.from(n.selection.getSelectedBlocks()).filter(t = > this._canBeAligned(t)
            ),
        ...
        function Kf(t, e=jf) {
            ...
            return n.bind("isEnabled").to(i), n instanceof jf ? n.bind("isOn").to(i, "isOpen") : n.arrowView.bind("isOn").to(i, "isOpen"), function (t) {
                (function (t) {
                    t.on("render", () = > {$f({emitter: t, activator:() =
                >
                    t.isOpen, callback
                :
                    () =
                ...
                ,
                    ...
                    t.on("execute", e = > {e.source instanceof Wf || (t.isOpen = !1)}
                )
                }(t), function (t) {
        ...
        function Gf(t, e) {
            ...
            t.extendTemplate({attributes: {class: ["ck-toolbar-dropdown"]}}), e.map(t = > n.items.add(t)
        ),
        ...
        function Jf(t, e) {
            ...
            if ("button" === t || "switchbutton" === t) {
                const o = new qf(n);
                let i;
                return (i = "button" === t ? new xf(n) : new Wf(n)).bind(...Object.keys(e)
            ).
        ...
        class rm extends Dh {
            ...
            init() {
                ...
                o.filter(If).forEach(t = > this._addButton(t)
            ),
                e.add("alignment", t = > {const i = Kf(t), r = o.map(t = > e.create(`alignment:${t}`)
            )
            ...
            >
                ...
                i.bind("isEnabled").toMany(r, "isEnabled", (...t) =
            >
                t.some(t = > t
            )),
                i
            ...
            _addButton(t) {
                const e = this.editor;
                e.ui.componentFactory.add(`alignment:${t}`, n = > {const o = e.commands.get("alignment"), i = new xf(n);
                return i.set({
                    label: this.localizedOptionTitles[t],
                    icon: im.get(t),
                    tooltip: !0
                }), i.bind("isEnabled").to(o), i.bind("isOn").to(o, "value", e = > e === t
            ),
                this.listenTo(i, "execute", () = > {e.execute("alignment", {value: t}), e.editing.view.focus()}
            ),
                i
            })
            }
        ...
        class fm extends Dh {
            constructor(t) {
                ...
                const e = cm(this.editor.config.get("fontSize.options")).filter(t = > t.model
            ),
                n = um(hm, e);
        ...
        class bm extends Dh {
            init() {
                ...
                t.ui.componentFactory.add("fontSize", i = > {const r = Kf(i);
                return Jf(r, function (t, e) {
                    ...
                    for (const o of t) {
                        ...
                        o.view && o.view.styles && t.model.set("labelStyle", `font-size:${o.view.styles["font-size"]}`), o.view && o.view.classes && t.model.set("class", `${t.model.class} ${o.view.classes}`), t.model.bind("isOn").to(e, "value", t = > t === o.model
                    ),
                        n.add(t)
                    }
                    return n
                    ...
                    t
                    .execute(e.source.commandName, {value: e.source.commandParam}),
                    t
                    .editing.view.focus()
                }
            ),
            ...
            _getLocalizedOptions() {
                ...
                return cm(t.config.get("fontSize.options")).map(t = > {const e = n[t.title];
        ...
        class xm extends Dh {
            ...
            init() {
                ...
                const e = vm(t.config.get("fontFamily.options")).filter(t = > t.model
            ),
                n = um(ym, e);
        ...
        class Tm extends Dh {
            init() {
                ...
                t.ui.componentFactory.add("fontFamily", i = > {const r = Kf(i);
                return Jf(r, function (t, e) {
                    const n = new zo;
                    for (const o of t) {
                        const t = {
                        ...
                        o.view && o.view.styles && t.model.set("labelStyle", `font-family: ${o.view.styles["font-family"]}`), n.add(t)
                    }
                    return n
                }(n, o)), r.buttonView.set({
                    label: e("m"),
        ...
        class Sm extends Hh {
            ...
            execute(t = {}) {
                const e = this.editor.model, n = e.document.selection, o = t.value;
                e.change(t = > {const i = e.schema.getValidRanges(n.getRanges(), "highlight");
                if (n.isCollapsed) {
                    const e = n.getFirstPosition();
                    if (n.hasAttribute("highlight")) {
                        const n = t =
                    >
                        t.item.hasAttribute("highlight") && t.item.getAttribute("highlight") === this.value, i = e.getLastMatchingPosition(n, {direction: "backward"}), r = e.getLastMatchingPosition(n), s = new ks(i, r);
        ...
        class Fm extends Sh {
            ...
            render() {
                super.render(), this.children.add(this.actionView), this.children.add(this.arrowView), this.focusTracker.add(this.actionView.element), this.focusTracker.add(this.arrowView.element), this.keystrokes.listenTo(this.element), this.keystrokes.set("arrowright", (t, e) = > {
                    this
                    .focusTracker.focusedElement === this.actionView.element && (this.arrowView.focus(), e())
                }
            ),
                this.keystrokes.set("arrowleft", (t, e) = > {
                    this
                    .focusTracker.focusedElement === this.arrowView.element && (this.actionView.focus(), e())
                }
            )
            }
        ...
        class Nm extends Dh {
            ...
            _addHighlighterButton(t) {
                ...
                this._addButton("highlight:" + t.model, t.title, Dm(t.type), t.model, function (n) {
                    n.bind("isEnabled").to(e, "isEnabled"), n.bind("isOn").to(e, "value", e = > e === t.model
                ),
        ...
        s.on("execute", () = > {r.execute("highlight", {value: o}), r.editing.view.focus()}
    ),
        i(s), s
    })
    }
        _addDropdown(t)
        {
            ...
            ;o.add("highlight", s = > {const a = e.commands.get("highlight"), c = Kf(s, Fm), l = c.buttonView;
            l.set({
                tooltip: n("bf"),
                lastExecuted: i.model,
                commandValue: i.model
            }), l.bind("icon").to(a, "value", t = > Dm(u(t, "type"))
        ),
            ...
            const d = t.map(t = > {const e = o.create("highlight:" + t.model);
            return this.listenTo(e, "execute", () = > c.buttonView.set({lastExecuted: t.model})
        ),
            e
        })
            ;
            ...
            return c.bind("isEnabled").toMany(d, "isEnabled", (...t) =
        >
            t.some(t = > t
        )),
            d.push(new Vh), d.push(o.create("removeHighlight")), Gf(c, d), function (t) {
                t.buttonView.actionView.iconView.bind("fillColor").to(t.buttonView, "color")
            }(c), l.on("execute", () = > {e.execute("highlight", {value: l.commandValue}), e.editing.view.focus()}
        ),
            c
        })
        }
        ...
        class zm extends Dh {
            ...
            init() {
                this.loaders = new zo, this.loaders.on("add", () = > this._updatePendingAction()
            ),
        ...
        class jm {
            constructor(t, e) {
                this.id = w(), this.file = t, this._adapter = e, this._reader = new Lm, this.set("status", "idle"), this.set("uploaded", 0), this.set("uploadTotal", null), this.bind("uploadedPercent").to(this, "uploaded", this, "uploadTotal", (t, e) = > e ? t / e * 100 : 0
            ),
        ...
        class Km {
            constructor(t, e, n) {
                ...
                c && t.model.enqueueChange(t = > {const e = ks.createFromParentsAndOffsets(a.parent, 0, a.parent, c[0].length);
        ...
        function Jm(t, e) {
            ...
            map(e = > ks.createFromParentsAndOffsets(t, e[0], t, e[1])
        )
        }
        ...
        class np extends Dh {
            init() {
                const t = this.editor, e = t.t;
                t.ui.componentFactory.add(ep, n = > {const o = t.commands.get(ep), i = new xf(n);
                return i.set({
                    label: e("n"),
                    icon: tp.a,
                    keystroke: "CTRL+B",
                    tooltip: !0
                }), i.bind("isOn", "isEnabled").to(o, "value", "isEnabled"), this.listenTo(i, "execute", () = > t.execute(ep)
            ),
                i
            })
            }
        ...
        class cp extends Dh {
            init() {
                const t = this.editor, e = t.t;
                t.ui.componentFactory.add(ap, n = > {const o = t.commands.get(ap), i = new xf(n);
                return i.set({
                    label: e("o"),
                    icon: sp.a,
                    keystroke: "CTRL+I",
                    tooltip: !0
                }), i.bind("isOn", "isEnabled").to(o, "value", "isEnabled"), this.listenTo(i, "execute", () = > t.execute(ap)
            ),
                i
            })
            }
        ...
        class mp extends Dh {
            init() {
                const t = this.editor, e = t.t;
                t.ui.componentFactory.add(fp, n = > {const o = t.commands.get(fp), i = new xf(n);
                return i.set({
                    label: e("p"),
                    icon: hp.a,
                    keystroke: "CTRL+SHIFT+X",
                    tooltip: !0
                }), i.bind("isOn", "isEnabled").to(o, "value", "isEnabled"), this.listenTo(i, "execute", () = > t.execute(fp)
            ),
                i
            })
            }
        ...
        class kp extends Dh {
            init() {
                const t = this.editor, e = t.t;
                t.ui.componentFactory.add(vp, n = > {const o = t.commands.get(vp), i = new xf(n);
                return i.set({
                    label: e("q"),
                    icon: wp.a,
                    keystroke: "CTRL+U",
                    tooltip: !0
                }), i.bind("isOn", "isEnabled").to(o, "value", "isEnabled"), this.listenTo(i, "execute", () = > t.execute(vp)
            ),
                i
            })
            }
        ...
        class _p extends Hh {
            ...
            execute() {
                ...
                this._removeQuote(t, o.filter(yp));
            else
                {
            ...
            _removeQuote(t, e) {
                xp(e).reverse().forEach(e = > {if(e.start.isAtStart && e.end.isAtEnd
            )
            ...
            _applyQuote(t, e) {
                const n = [];
                xp(e).reverse().forEach(e = > {let o = yp(e.start);
        ...
        class Ep extends Dh {
            init() {
                const t = this.editor, e = t.t;
                t.ui.componentFactory.add("blockQuote", n = > {const o = t.commands.get("blockQuote"), i = new xf(n);
                return i.set({
                    label: e("r"),
                    icon: Sp.a,
                    tooltip: !0
        ...
        class ig extends Dh {
            init() {
                ...
                }), o.for("dataDowncast").add(Fs({model: "image", view: (t, e) = > rg(e)
            })),
                o.for("editingDowncast").add(Fs({model: "image", view: (t, e) = > (function (t, e, n) {
        ...
        class cg extends Dh {
            ...
            init() {
                ...
                t.addObserver(sg), this.listenTo(e, "mousedown", (...t) =
            >
                this._onMousedown(...t
            )),
            ...
            _selectAllNestedEditableContent() {
                ...
                return e.getFirstRange().root != n && (t.change(t = > {t.setSelection(ks.createIn(n))}), !0
            )
            }
            ...
            _selectAllContent() {
                ...
                if (n && Yp(n)) {
                    ...
                    return t.change(t = > {t.setSelection(ks.createIn(o))}
                ),
                    !0
                }
                return !1
            ...
            _setSelectionOverElement(t) {
                this.editor.model.change(e = > {e.setSelection(ks.createOn(t))}
            )
            }
        ...
        Ag.arrowHorizontalOffset = 25, Ag.arrowVerticalOffset = 10, Ag._getOptimalPosition = function ({element: t, target: e, positions: n, limiter: o, fitInViewport: i}) {
            ...
            if (o || i) {
                ...
                [l, c] = function (t, e, n, o, i) {
                    let r, s, a = 0, c = 0;
                    const l = n.getArea();
                    return t.some(t = > {const[d, u] = kg(t, e, n);
                    let h, f;
                    if (o) if (i) {
        ...
        }, Ag.defaultPositions = {northArrowSouth: (t, e) = > ({
            top: Tg(t, e),
    ...
    :
        (t, e) =
    >
        ({top: Tg(t, e), left: t.left + t.width / 2 - Ag.arrowHorizontalOffset, name: "arrow_sw"}), northWestArrowSouth
    :
        (t, e) =
    >
        ({top: Tg(t, e), left: t.left - e.width / 2, name: "arrow_s"}), northWestArrowSouthWest
    :
        (t, e) =
    >
        ({top: Tg(t, e), left: t.left - Ag.arrowHorizontalOffset, name: "arrow_sw"}), northWestArrowSouthEast
    :
        (t, e) =
    >
        ({top: Tg(t, e), left: t.left - e.width + Ag.arrowHorizontalOffset, name: "arrow_se"}), northEastArrowSouth
    :
        (t, e) =
    >
        ({top: Tg(t, e), left: t.right - e.width / 2, name: "arrow_s"}), northEastArrowSouthEast
    :
        (t, e) =
    >
        ({top: Tg(t, e), left: t.right - e.width + Ag.arrowHorizontalOffset, name: "arrow_se"}), northEastArrowSouthWest
    :
        (t, e) =
    >
        ({top: Tg(t, e), left: t.right - Ag.arrowHorizontalOffset, name: "arrow_sw"}), southArrowNorth
    :
        (t, e) =
    >
        ({top: Sg(t), left: t.left + t.width / 2 - e.width / 2, name: "arrow_n"}), southArrowNorthEast
    :
        (t, e) =
    >
        ({
    ...
    :
        (t, e) =
    >
        ({top: Sg(t), left: t.left + t.width / 2 - Ag.arrowHorizontalOffset, name: "arrow_nw"}), southWestArrowNorth
    :
        (t, e) =
    >
        ({top: Sg(t), left: t.left - e.width / 2, name: "arrow_n"}), southWestArrowNorthWest
    :
        (t, e) =
    >
        ({top: Sg(t), left: t.left - Ag.arrowHorizontalOffset, name: "arrow_nw"}), southWestArrowNorthEast
    :
        (t, e) =
    >
        ({top: Sg(t), left: t.left - e.width + Ag.arrowHorizontalOffset, name: "arrow_ne"}), southEastArrowNorth
    :
        (t, e) =
    >
        ({top: Sg(t), left: t.right - e.width / 2, name: "arrow_n"}), southEastArrowNorthEast
    :
        (t, e) =
    >
        ({top: Sg(t), left: t.right - e.width + Ag.arrowHorizontalOffset, name: "arrow_ne"}), southEastArrowNorthWest
    :
        (t, e) =
    >
        ({top: Sg(t), left: t.right - Ag.arrowHorizontalOffset, name: "arrow_nw"})
    }
        ;
        ...
        class Vg extends Dh {
            ...
            _createForm() {
                ...
                this.listenTo(t.ui, "update", () = > {ng(e.selection
            )
                    ? this._isVisible && Rg(t) : this._hideForm(!0)
            }),
                $f({emitter: this._form, activator: () = > this._isVisible, contextElements
            :
        ...
        class Hg extends Dh {
            init() {
                const t = this.editor, e = t.t;
                t.ui.componentFactory.add("imageUpload", n = > {const o = new Ng(n), i = t.commands.get("imageUpload");
        ...
        class Wg extends Dh {
            ...
            uploadStatusChange(t, e, n) {
                ...
                "complete" == a && s.loaders.get(r) && !Jo.isEdge && function (t, e, n) {
                    ...
                    e.insert(Mo.createAt(t, "end"), o), setTimeout(() = > {n.change(t = > t.remove(Fo.createOn(o))
                )
                },
                    3e3
                )
        ...
        class rb extends Dh {
            ...
            init() {
                ...
                if (rb.paragraphLikeElements.has(e.viewItem.name)) {
                ...
                n.upcastDispatcher.on("text", (t, e, n) = > {
                    e
                    .modelRange || ab(e.viewItem, e.modelCursor, n.schema) && (e = Object.assign(e, sb(e.viewItem, e.modelCursor, n)))
                }, {priority: "lowest"}
            ),
        ...
        class cb extends Hh {
            ...
            execute(t) {
                const e = this.editor.model, n = e.document, o = t.value;
                e.change(t = > {const i = Array.from(n.selection.getSelectedBlocks()).filter(t = > lb(t, o, e.schema)
            )
                ;
        ...
        class ub extends Dh {
            ...
            afterInit() {
                ...
                !i.is(db) && 0 === i.childCount && o.writer.rename(i, db)
            })
            }
        }
        ...
        function mb(t, e, n, o) {
            ...
            fb.get(i).set(e, {placeholderText: n, checkFunction: o}), t.render()
        }
        ...
        class vb extends Dh {
            init() {
                ...
                t.conversion.for("upcast").add(aa({view: wb, model: "caption"}));
                ...
                i.downcastDispatcher.on("insert:caption", kb(s)), i.downcastDispatcher.on("insert", this._fixCaptionVisibility(t = > t.item), {priority: "high"}
            ),
        ...
        class Lb extends Dh {
            ...
            _createButton(t) {
                ...
                e.ui.componentFactory.add(n, n = > {const o = e.commands.get("imageStyle"), i = new xf(n);
                return i.set({
                    label: t.title,
                    icon: t.icon,
                    tooltip: !0
        ...
        class Ub extends Hh {
            ...
            execute() {
                ...
                t.change(t = > {const n = e.isCollapsed ? [jb(e.getFirstPosition(), e.getAttribute("linkHref"))] : e.getRanges();
        ...
        class Yb {
            constructor(t, e, n) {
                this.model = t, this.attribute = n, this._modelSelection = t.document.selection, this._overrideUid = null, this._isNextGravityRestorationSkipped = !1, e.listenTo(this._modelSelection, "change:range", (t, e) = > {
                    this
                    ._isNextGravityRestorationSkipped ? this._isNextGravityRestorationSkipped = !1 : this._isGravityOverridden && (!e.directChange && Qb(this._modelSelection.getFirstPosition(), n) || this._restoreGravity())
                }
            )
            }
        ...
        class ow extends Dh {
            init() {
                ...
                t.model.schema.extend("$text", {allowAttributes: "linkHref"}), t.conversion.for("dataDowncast").add(Ns({
                    model: "linkHref",
                    view: Gb
                })), t.conversion.for("editingDowncast").add(Ns({model: "linkHref", view: (t, e) = > Gb(Jb(t), e)
            })),
            ...
            _setupLinkHighlight() {
                ...
                if (o.hasAttribute("linkHref")) {
                    const i = jb(o.getFirstPosition(), o.getAttribute("linkHref")), r = t.editing.mapper.toViewRange(i);
            ...
            _createPreviewButton() {
                ...
                return t.set({
                    ...
                    attributes: {
                        ...
                        href: e.to("href", t = > t && Jb(t)), target
            :
                "_blank"
            }
            }),
                t.bind("label").to(this, "href", t = > t || n("bw")
            ),
        ...
        class mw extends Dh {
            ...
            _createActionsView() {
                ...
                e.keystrokes.set(fw, (t, e) = > {this._addFormView(), e()}
            ),
                e
            }
            ...
            _createToolbarLinkButton() {
                ...
                t.keystrokes.set(fw, (t, n) = > {n(), e.isEnabled && this._showUI()}
            ),
                t.ui.componentFactory.add("link", t = > {const o = new xf(t);
                return o.isEnabled = !0, o.label = n("u"), o.icon = hw.a, o.keystroke = fw, o.tooltip = !0, o.bind("isEnabled").to(e, "isEnabled"), this.listenTo(o, "execute", () = > this._showUI()
            ),
                o
            })
            }
            ...
            _enableUserBalloonInteractions() {
                ...
                $f({emitter: this.formView, activator: () = > this._isUIVisible, contextElements
            :
        ...
        class gw extends Hh {
            ...
            execute() {
                const t = this.editor.model, e = t.document,
                    n = Array.from(e.selection.getSelectedBlocks()).filter(e = > ww(e, t.schema)
            ),
                o = !0 === this.value;
                t.change(t = > {
                    if(o) {
        ...
        function Nw(t, e, n, o, i) {
            ...
            (t.is("ul") || t.is("ol")) && (l = a.move(Fo.createOn(t), l).end, Mw(a, t, t.nextSibling), Mw(a, t.previousSibling, t))
        }
        ...
        class Uw extends Dh {
            ...
            _addButton(t, e, n) {
                const o = this.editor;
                o.ui.componentFactory.add(t, i = > {const r = o.commands.get(t), s = new xf(i);
                return s.set({
                    label: e,
                    icon: n,
                    tooltip: !0
        ...
        >
            {
                t.on("element:table", (t, e, n) = > {const o = e.viewItem;
                ...
                if (n.writer.insert(c, l.position), n.consumable.consume(o, {name: !0}), i.length) i.forEach(t = > n.convertItem(t, vs.createAt(c, "end"))
            )
                ;
            else
                {
        ...
        function Xw(t={}) {
            return e =
        >
            e.on("insert:table", (e, n, o) = > {const i = n.item;
        ...
        function Zw(t={}) {
            return e =
        >
            e.on("insert:tableRow", (e, n, o) = > {const i = n.item;
            if (!o.consumable.consume(i, "insert")) return;
        ...
        function tv(t={}) {
            return e =
        >
            e.on("insert:tableCell", (e, n, o) = > {const i = n.item;
            if (!o.consumable.consume(i, "insert")) return;
        ...
        function ev(t={}) {
            ...
            return t =
        >
            t.on("attribute:headingRows:table", (t, n, o) = > {const i = n.item;
        ...
        function nv(t={}) {
            ...
            return t =
        >
            t.on("attribute:headingColumns:table", (t, n, o) = > {const i = n.item;
            if (!o.consumable.consume(n.item, t.name)) return;
            const r = {
                headingRows: i.getAttribute("headingRows") || 0,
                headingColumns: i.getAttribute("headingColumns") || 0
        ...
        class mv extends Dh {
            ...
            createTable(t, e, n) {
                return this.editor.model.change(o = > {const i = o.createElement("table");
            ...
            insertRows(t, e = {}) {
                ...
                n.change(e = > {const n = t.getAttribute("headingRows") || 0;
            ...
            insertColumns(t, e = {}) {
                ...
                n.change(e = > {const n = t.getAttribute("headingColumns");
            ...
            splitCellHorizontally(t, e = 2) {
                ...
                {
                    const a = [...new
                    Kw(o, {startRow: i, endRow: i + r - 1, includeSpanned: !0})
                ],
                    {
                        newCellsSpan:c, updatedSpan
                    :
                        l
                    }
                    = bv(r, e);
                    Jw("rowspan", l, t, n);
                    const {column: d} = a.find(({cell: e}) = > e === t
                ),
                    u = {};
            ...
            getColumns(t) {
                return [...t.getChild(0).getChildren()
            ].
                reduce((t, e) = > {return t + parseInt(e.getAttribute("colspan") || 1)}, 0
            )
            }
        }
        ...
        class wv extends Hh {
            ...
            execute(t = {}) {
                ...
                e.change(t = > {const e = o.createTable(a, i, r);
        ...
        class yv extends Hh {
            ...
            execute() {
                const t = this.editor.model, e = t.document.selection.getFirstPosition().parent, n = this.value,
                    o = this.direction;
                t.change(t = > {const i = "right" == o || "down" == o, r = i ? e : n, s = i ? n : e, a = s.parent;
            ...
            _getMergeableCell() {
                ...
                const e = this.editor.plugins.get(mv), n = this.isHorizontal ? function (t, e, n) {
                    ...
                    const s = parseInt(t.getAttribute("rowspan") || 1), a = "down" == e ? i + s : i, c = [...new
                    Kw(o, {endRow: a})
                ],
                    l = c.find(e = > e.cell === t
                ).
        ...
        class xv extends Hh {
            ...
            execute() {
                ...
                t.change(t = > {i && o <= i && Jw("headingRows", i - 1, n, t, 0);
                const r = [...new
                Kw(n, {endRow: o})
            ],
                s = new Map;
                r.filter(({row: t, rowspan: e}) = > t === o && e > 1
            ).
                forEach(({column: t, cell: e, rowspan: n}) = > s.set(t, {cell: e, rowspanToSet: n - 1})
            ),
                r.filter(({row: t, rowspan: e}) = > t <= o - 1 && t + e > o
            ).
                forEach(({cell: e, rowspan: n}) = > Jw("rowspan", n - 1, e, t)
            )
                ;const a = o + 1, c = new Kw(n, {includeSpanned: !0, startRow: a, endRow: a});
                let l;
                for (const {row: e, column: o, cell: i}of[...c]
            )
                if (s.has(o)) {
                    const {cell: i, rowspanToSet: r} = s.get(o), a = l ? vs.createAfter(l) : vs.createAt(n.getChild(e));
        ...
        class Av extends Hh {
            ...
            execute() {
                const t = this.editor.model, e = t.document.selection.getFirstPosition().parent, n = e.parent,
                    o = n.parent, i = o.getAttribute("headingColumns") || 0, r = o.getChildIndex(n), s = [...new
                Kw(o)
            ],
                a = s.find(t = > t.cell === e
            ).
                column;
                t.change(t = > {i && r <= i && t.setAttribute("headingColumns", i - 1, o);
        ...
        function Tv(t, e, n) {
            ...
            a > 1 && (s.rowspan = a);
            const c = i.getChildIndex(o), l = c + r, d = [...new
            Kw(i, {startRow: c, endRow: l, includeSpanned: !0})
        ]
            ;let u;
        ...
        class Sv extends Hh {
            ...
            execute() {
                ...
                s + 1 !== r && s++, t.change(t = > {Jw("headingColumns", s, i, t, 0
            )
            })
            }
        ...
        class Ev extends Dh {
            init() {
                ...
                e.register("table", {
                    ...
                    t
                    .stop();
                const o = n.mapper.toViewPosition(e.position).getLastMatchingPosition(t = > !t.item.is("tr")
            ).
                nodeAfter, i = o.parent, r = Fo.createOn(o), s = n.writer.remove(r);
                ...
                n.for("upcast").add(aa({model: "tableCell", view: "td"})), n.for("upcast").add(aa({
                    model: "tableCell",
                    view: "th"
            ...
            _handleTabOnSelectedTable(t, e) {
                ...
                if (!o.isCollapsed && 1 === o.rangeCount && o.getFirstRange().isFlat) {
                    ...
                    t.stop(), e.preventDefault(), e.stopPropagation(), n.model.change(t = > {
                        t
                        .setSelection(ks.createIn(i.getChild(0).getChild(0)))
                    }
                )
                }
            }
            ...
            _handleTabInsideTable(t, e) {
                ...
                n.model.change(t = > {t.setSelection(ks.createIn(f))}
            )
            }
        }
        ...
        class Pv extends Sh {
            constructor(t) {
                super(t);
                const e = this.bindTemplate;
                this.items = this.createCollection(), this.set("rows", 0), this.set("columns", 0), this.bind("label").to(this, "columns", this, "rows", (t, e) = > `${e} x ${t}`
            ),
                this.setTemplate({
                    tag: "div",
                    attributes: {class: ["ck"]},
                    ...
                    on: {mousedown: e.to(t = > {t.preventDefault()}), click
            :
                e.to(() = > {this.fire("execute")}
            )
            }
            })
                ;
                for (let t = 0; t < 100; t++) {
                    const e = new Ov;
                    e.on("over", () = > {const e = Math.floor(t / 10), n = t % 10;
            ...
            _highlightGridBoxes() {
                ...
                this.items.map((n, o) = > {const i = Math.floor(o / 10) < t && o % 10 < e;
                n.set("isOn", i)
            })
            }
        }
        ...
        class Lv extends Dh {
            init() {
                ...
                t.ui.componentFactory.add("insertTable", n = > {const o = t.commands.get("insertTable"), i = Kf(n);
                ...
                i.on("execute", () = > {
                    t
                    .execute("insertTable", {rows: r.rows, columns: r.columns}),
                    t
                    .editing.view.focus()
                }
            ),
            ...
            >
                ...
                this.listenTo(r, "execute", t = > {i.execute(t.source.commandName), i.editing.view.focus()}
            ),
                r
            }
        }
        ...
        qv.builtinPlugins = [class extends Dh {
            ...
            _addHeadingAutoformats() {
                ...
                new Km(this.editor, n, () = > {this.editor.execute("heading", {value: t})}
            )
            })
            }
            ...
            init() {
                ...
                e && this.listenTo(e, "show", e = > {ng(t.editing.view.document.selection
            )&&
                e.stop()
            },
                {
            ...
            init() {
                const t = this.editor, e = t.plugins.get("BalloonToolbar");
                e && this.listenTo(e, "show", e = > {(function (t) {
                    const e = t.getSelectedElement();
                    return !(!e || !Qw(e))
